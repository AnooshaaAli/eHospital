...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws IOException {
		...
		showPrescribeMedicationsPage();
	}
    
	public void showPrescribeMedicationsPage() throws IOException {
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(Main.class.getResource("prescribeMedications.fxml"));
